...
```
*
Pols dataset contains year, month, gov_gap, rep_gap, gov_dem, and president.
snp dataset contains year, month, close
unemployment dataset contain year, month and unemployment.
We combined those three datasets by year and month. The data range from 1947-2015, and talks anou the political, snp and unempolyment status. 
